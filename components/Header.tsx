          ...
          <div className="flex items-center justify-between h-28 md:h-32">
            ...
            <Link href="/" className="flex items-center shrink-0">
              <svg
                ...
                style={{ width: "auto", transition: "fill 120ms linear" }}
