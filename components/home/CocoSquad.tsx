...
const LEADERS: Leader[] = [
  ...
  },
  {
    ...
    focus: "Marketing & Brand Direction",
    desc: "Shapes how the world sees Nastar Coco — telling the brand's story and growing its reach across every audience.",
    keywords: ["Marketing", "Brand", "Reach"],
    accent: "#1F5A34",
    accentSoft: "#2E7A4A",
    accentDeep: "#1A4A2B",
    iconInk: "#FBF3E2",
